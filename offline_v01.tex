...
\begin{table}[]
	...
	\begin{tabular*}{\textwidth}{lllllllll}
		...
		Betriebstemperatur						& $T_{tar}$				& $\degree{C}$ 		& 77 		& \cite{Tjarks.2017}	& 60 					& Hammoudi	& 850 					& Ni 		\\[2ex]
		maximale Temperatur						& $T_{max}$				& $\degree{C}$ 		& 85 		& \cite{Tjarks.2017}	& 80 					& Hammoudi	& 1050 					& Ni 		\\
		minimale Temperatur						& $T_{min}$				& $\degree{C}$ 		& 20 		& \cite{Tjarks.2017}	& 20 					& Hammoudi	& 700 					& Ni 		\\
		maximale Stromdichte 					& $i_{max}$ 			& $A/{cm^2}$ 		& 3.0 		& \cite{Tjarks.2017}	& 0.3 					& Hammoudi	& 0.8 					& Petipas 	\\
		Zellen pro Stack						& $N_{ce_{st}}$			& -				 	& 200		& \cite{Tjarks.2017}		& 24					& Hammoudi 	& 400 					& Petipas 	\\
		spez. Wärmekapazität					& $C_{t_{spec}}$		& $kJ/KN_{ce}$ 		& 1.2500	& \cite{Tjarks.2017}		& 4.8906 				& \cite{Ulleberg.2003}		& 0,0969				& Petipas 	\\
		spez. Wärmedurchgangskoeffizient		& $H_{AX_{spec}}$		& $W/Kcm^{2}N_{ce}$				& 0.028		& Gabr					& 0,011 	& Gabr		& ??? 		& - 		\\
		spez. Wärmedurchgangswiderstand			& $R_{t_{spec}}$		& $K/W$				& 0,167 	& \cite{Ulleberg.2003}		& 0,167					& \cite{Ulleberg.2003}		& 0,840					& Petipas 	\\
		Kühlwassereingangstemperatur			& $T_{cw_{in}}$			& $\degree{C}$ 		& 15 		& \cite{Ulleberg.2003}		& 15 					& \cite{Ulleberg.2003}		& 	 					& 	 		\\	
		Degradationsgradient 					& $deg$ 				& ${\mu}V/h$		& 4-8 		& \cite{Buttler.2018}	& 1-2 					& Buttler	& 21 					& De-Niang 	\\
		
		&&&&&&&& \\
		\textbf{Anoden-Kennwerte}&&&&&&&& \\
		Elektrodenmaterial 						& - 					& -					& - 		& -	 		& - 					& Hammoudi	& - 					& -			\\
		Elektrodenoberfläche 					& $A_{an}$				& $cm^{2}$			& 170 		& \cite{Gabrielli2016}	& 300					& Hammoudi 	& 100 					& Petipas 	\\
		Elektrodendurchmesser 					& $\delta_{an}$			& $cm$ 				& 0,14 		& \cite{Chandesris2015} 	& 0,2 					& Hammoudi	& 0,05 					& Zhang 	\\
		...
		Ladungstransferkoeffizient 				& $\alpha_{an}$ 		& - 				& 0,65 		& \cite{Chandesris2015}	& 1,65 					& Abdin		& 	 					& 	 		\\
		Freie Aktivierungsenergie 				& ${\Delta}G_{c_{an}}$	& $J/mol$ 			& 62836		& \cite{Chandesris2015}	& 80510 				& Abdin		& 120000 				& Zhang 	\\
		...
		Elektrodenmaterial 						& - 					& - 				& - 		& - 		& -		 				& Hammoudi 	& - 					& - 		\\
		Elektrodenoberfläche 					& $A_{ca}$ 				& $cm^{2}$ 			& 170 		& \cite{Gabrielli2016}	& 300 					& Hammoudi 	& 100 					& Petipas	\\
		Elektrodendurchmesser 					& $\delta_{ca}$ 		& $cm$ 				& 0,235		& \cite{Chandesris2015}	& 0,2 					& Hammoudi 	& 0,5 					& Zhang 	\\
		...
		Ladungstransferkoeffizient 				& $\alpha_{ca}$ 		& - 				& 0,51 		& \cite{Chandesris2015}	& 0,73 					& Abdin 	& 	 					& 	 		\\
		Freie Aktivierungsenergie 				& ${\Delta}G_{c_{ca}}$ 	& $J/mol$		    & 24359		& \cite{Chandesris2015}	& 80510 				& Abdin 	& 100000 				& Zhang 	\\
		...
		Durchmesser								& $\delta_{mem}$		& $\mu{m}$			& 200		& \cite{Gabrielli2016}	&			&			& 500   & Zhang \\			
